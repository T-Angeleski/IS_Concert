...
namespace ConcertLab.Web.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Date,Place,Price,ImageURL")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Date,Place,Price,ImageURL")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
